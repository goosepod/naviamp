...
internal val NaviampVisualizer.shaderSource: String
    get() = when (this) {
        ...
        NaviampVisualizer.AnalogSignalFailure -> nativeSkiaShaderSource()
        NaviampVisualizer.FluidGradient -> FluidGradientShaderSkSL
        NaviampVisualizer.FluidicNebulae -> nativeSkiaShaderSource()
        ...
        NaviampVisualizer.OceanHorizon -> nativeSkiaShaderSource()
        NaviampVisualizer.OceanOfInk -> nativeSkiaShaderSource()
        NaviampVisualizer.RaymarchedSphereLiquid -> nativeSkiaShaderSource()
...
internal val NaviampVisualizer.usesTranslatedNativeSkiaShader: Boolean
    get() = when (this) {
        ...
        NaviampVisualizer.RaymarchedSphereLiquid -> true
        else -> false
    }

private fun NaviampVisualizer.nativeSkiaShaderSource(): String =
    NativeSkiaShaderTranslator.translateFragmentShader(requireNotNull(nativeShaderDefinition).fragmentSource)

internal const val CommonShaderHeader = """

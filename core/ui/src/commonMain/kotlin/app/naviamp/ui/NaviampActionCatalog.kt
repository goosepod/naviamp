...
enum class NaviampAction(
    ...
    StartTrackRadio("Start Radio", NaviampTransportIcons.Radio),
    ...
    StartAlbumRadio("Start Radio", NaviampTransportIcons.Radio),
    StartArtistRadio("Start Radio", NaviampTransportIcons.Radio),

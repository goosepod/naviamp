...
const val AndroidPlaybackSessionSaveIntervalMillis = 30_000L
...
const val AndroidRadioRefillThreshold = 10
const val AndroidRadioRefillCount = 50
const val AndroidRadioQueueHistoryLimit = 25
const val AndroidPopularTrackFallbackLimit = 120L
const val ProviderArtistPopularTrackAlbumFallbackLimit = 4

...
data class AndroidAppShellUiState(
    ...
    val connectionSettings: NaviampConnectionSettingsUi,
    val general: NaviampGeneralSettingsUi,
    val playback: NaviampPlaybackSettingsUi,
    val cache: NaviampCacheSettingsUi,

...
fun rememberAndroidCoreUriPickers(): AndroidCoreUriPickers {
    ...
    val directoryState = remember { AndroidCoreUriPickerState() }
    val documentState = remember { AndroidCoreUriPickerState() }
    ...
    return remember(directoryState, documentState) {
        AndroidCoreUriPickers(

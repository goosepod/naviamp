...
- **Next recommended item:** Complete the remaining Milestone 4 physical-device behavior matrix on the installed Pixel 10a: exercise background/service restoration, system media controls, storage/document access, downloads, and Android Auto. Do not begin Milestone 5 until the Android acceptance findings are recorded or explicitly deferred.
